...
namespace RhosRequests.RandomStuff
{
	...
	internal class ExampleFlailProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ProjectileID.RocketIV, Projectile.damage, Projectile.knockBack, Main.myPlayer);
				Projectile.ai[1]++;
			}
		}
	}
